...
function initPluginVueOptions(options, UniVitePlugins, uniPluginOptions) {
    ...
    compilerOptions.dom2 = isDom2Harmony;
    // 默认就移除comments节点
    ...
    if (options.platform !== 'h5' && options.platform !== 'web') {
        compilerOptions.nodeTransforms.push(...(0, uni_cli_shared_1.getBaseNodeTransforms)(options.base, isDom2Harmony ? (0, uni_cli_shared_1.createResolveStaticAsset)(options.inputDir) : undefined));
    }
    if (nodeTransforms) {
